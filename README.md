...
Android版安装包：[点击去下载](https://github.com/simplezhli/myapp8/releases)。

iOS需要自行下载代码运行。

Web体验地址：https://simplezhli.github.io/myapp8/

## 项目运行环境

[![myapp8 driver](https://github.com/simplezhli/myapp8/actions/workflows/flutter-drive.yml/badge.svg?branch=master)](https://github.com/simplezhli/myapp8/actions/workflows/flutter-drive.yml)
...
详细内容可以参看[pubspec.yaml](https://github.com/simplezhli/myapp8/blob/master/pubspec.yaml)文件
