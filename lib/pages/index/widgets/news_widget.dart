...
class _MarqueeSingleState extends State<MarqueeSingle> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return ClipRect(
        child: FractionalTranslation(translation: _animation.value, child: SingleChildScrollView(scrollDirection: Axis.horizontal, child: widget.child)));
  }
...
class MarqueeContinuous extends StatefulWidget {
  ...
  const MarqueeContinuous({Key? key, required this.child, this.duration = const Duration(seconds: 2), this.stepOffset = 50.0}) : super(key: key);
