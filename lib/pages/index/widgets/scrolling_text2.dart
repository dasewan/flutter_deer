...
class ScrollingText2 extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return ScrollingText2State();
  }
}

class ScrollingText2State extends State<ScrollingText2> with SingleTickerProviderStateMixin {
  ...
  void startTimer() {
    if (key.currentContext != null) {
      ...
      timer = Timer.periodic(Duration(milliseconds: widget.restTime), (timer) {
        ...
        scrollController!.animateTo(position, duration: Duration(milliseconds: widget.restTime), curve: widget.scrollCurve ?? Curves.linear);
      });
    }
  }
