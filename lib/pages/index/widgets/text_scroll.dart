...
/// )
/// ```
class TextScroll2 extends StatefulWidget {
  const TextScroll2(
    this.text, {
    Key? key,
    this.style,
  ...
  @override
  State<TextScroll2> createState() => _TextScroll2State();
}

class _TextScroll2State extends State<TextScroll2> {
  ...
  @override
  void didUpdateWidget(covariant TextScroll2 oldWidget) {
    _onUpdate(oldWidget);
  ...
  Widget build(BuildContext context) {
    ...
    assert(!widget.fadedBorder || (widget.fadedBorder && widget.fadedBorderWidth != null && widget.fadedBorderWidth! > 0 && widget.fadedBorderWidth! <= 1),
...
/*    await _scrollController.animateTo(
  ...
  void _onUpdate(TextScroll2 oldWidget) {
...
/// Animation types for [TextScroll2] widget.
///
