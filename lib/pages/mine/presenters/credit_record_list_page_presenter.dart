...
class CreditRecordListPagePresenter extends BasePagePresenter<CreditRecordListIMvpView> {
  CreditRecordListPagePresenter();
  ...
  Future index(bool isShowDialog, [bool refresh = false]) {
    ...
    return requestNetwork<CreditHistoryEntity>(Method.get, url: HttpApi.creditLog, queryParameters: params, isShow: isShowDialog, onSuccess: (reponse) {
      if (reponse != null) {
        final List<CreditHistoryData> _transactions = reponse.data!;
