...
class IndexData {
	...
	@JSONField(name: "login_page_info")
...
@JsonSerializable()
class IndexDataLoginPageInfo {
	@JSONField(name: "app_name")
	String? appName = '';
	@JSONField(name: "first_tip")
	String? firstTip = '';
	@JSONField(name: "second_tip")
	String? secondTip = '';
	@JSONField(name: "show_contact_phone")
	bool? showContactPhone = false;
	@JSONField(name: "contact_phone")
	String? contactPhone = '';
	@JSONField(name: "show_contact_wa")
	bool? showContactWa = false;
	@JSONField(name: "contact_wa")
	String? contactWa = '';
	@JSONField(name: "captcha_show_count")
	int? captchaShowCount = 0;

	IndexDataLoginPageInfo();

	factory IndexDataLoginPageInfo.fromJson(Map<String, dynamic> json) => $IndexDataLoginPageInfoFromJson(json);

	Map<String, dynamic> toJson() => $IndexDataLoginPageInfoToJson(this);
