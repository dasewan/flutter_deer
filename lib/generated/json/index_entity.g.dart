...
IndexEntity $IndexEntityFromJson(Map<dynamic, dynamic> json) {
...
IndexData $IndexDataFromJson(Map<dynamic, dynamic> json) {
  final IndexData indexData = IndexData();
  final IndexDataAUser? aUser = jsonConvert.convert<IndexDataAUser>(
      json['a_user']);
  if (aUser != null) {
    indexData.aUser = aUser;
  }
  final String? bProductsNewestUpdatedAt = jsonConvert.convert<String>(
      json['b_products_newest_updated_at']);
  if (bProductsNewestUpdatedAt != null) {
    indexData.bProductsNewestUpdatedAt = bProductsNewestUpdatedAt;
  }
  final List<IndexDataBProducts>? bProducts = (json['b_products'] as List<
      dynamic>?)
      ?.map(
          (e) =>
      jsonConvert.convert<IndexDataBProducts>(e) as IndexDataBProducts)
      .toList();
  if (bProducts != null) {
    indexData.bProducts = bProducts;
  }
  final String? bCProductFeaturesUpdatedAt = jsonConvert.convert<String>(
      json['b_c_product_features_updated_at']);
  if (bCProductFeaturesUpdatedAt != null) {
    indexData.bCProductFeaturesUpdatedAt = bCProductFeaturesUpdatedAt;
  }
  final List<
      IndexDataBCProductFeatures>? bCProductFeatures = (json['b_c_product_features'] as List<
      dynamic>?)?.map(
          (e) =>
      jsonConvert.convert<IndexDataBCProductFeatures>(
          e) as IndexDataBCProductFeatures).toList();
  if (bCProductFeatures != null) {
    indexData.bCProductFeatures = bCProductFeatures;
  }
  final String? dBorrowsNewestUpdatedAt = jsonConvert.convert<String>(
      json['d_borrows_newest_updated_at']);
  if (dBorrowsNewestUpdatedAt != null) {
    indexData.dBorrowsNewestUpdatedAt = dBorrowsNewestUpdatedAt;
  }
  final List<IndexDataDBorrows>? dBorrows = (json['d_borrows'] as List<
      dynamic>?)
      ?.map(
          (e) => jsonConvert.convert<IndexDataDBorrows>(e) as IndexDataDBorrows)
      .toList();
  if (dBorrows != null) {
    indexData.dBorrows = dBorrows;
  }
  final String? rFNotificationsNewestUpdatedAt = jsonConvert.convert<String>(
      json['r_f_notifications_newest_updated_at']);
  if (rFNotificationsNewestUpdatedAt != null) {
    indexData.rFNotificationsNewestUpdatedAt = rFNotificationsNewestUpdatedAt;
  }
  final List<
      IndexDataRFNotifications>? rFNotifications = (json['r_f_notifications'] as List<
      dynamic>?)?.map(
          (e) =>
      jsonConvert.convert<IndexDataRFNotifications>(
          e) as IndexDataRFNotifications).toList();
  if (rFNotifications != null) {
    indexData.rFNotifications = rFNotifications;
  }
  final String? qDBannersNewestUpdatedAt = jsonConvert.convert<String>(
      json['q_d_banners_newest_updated_at']);
  if (qDBannersNewestUpdatedAt != null) {
    indexData.qDBannersNewestUpdatedAt = qDBannersNewestUpdatedAt;
  }
  final List<IndexDataQDBanners>? qDBanners = (json['q_d_banners'] as List<
      dynamic>?)
      ?.map(
          (e) =>
      jsonConvert.convert<IndexDataQDBanners>(e) as IndexDataQDBanners)
      .toList();
  if (qDBanners != null) {
    indexData.qDBanners = qDBanners;
  }
  final IndexDataRemind? remind = jsonConvert.convert<IndexDataRemind>(
      json['remind']);
  if (remind != null) {
    indexData.remind = remind;
  }
  final String? backTipsUpdatedAt = jsonConvert.convert<String>(
      json['back_tips_updated_at']);
  if (backTipsUpdatedAt != null) {
    indexData.backTipsUpdatedAt = backTipsUpdatedAt;
  }
  final List<IndexDataBackTips>? backTips = (json['back_tips'] as List<
      dynamic>?)
      ?.map(
          (e) => jsonConvert.convert<IndexDataBackTips>(e) as IndexDataBackTips)
      .toList();
  if (backTips != null) {
    indexData.backTips = backTips;
  }
  final IndexDataLoginPageInfo? loginPageInfo = jsonConvert.convert<
      IndexDataLoginPageInfo>(json['login_page_info']);
  if (loginPageInfo != null) {
    indexData.loginPageInfo = loginPageInfo;
  }
  return indexData;
}
...
Map<String, dynamic> $IndexDataToJson(IndexData entity) {
  ...
  data['b_c_product_features'] =
      entity.bCProductFeatures?.map((v) => v.toJson()).toList();
  data['d_borrows_newest_updated_at'] = entity.dBorrowsNewestUpdatedAt;
  data['d_borrows'] = entity.dBorrows?.map((v) => v.toJson()).toList();
  data['r_f_notifications_newest_updated_at'] =
      entity.rFNotificationsNewestUpdatedAt;
  data['r_f_notifications'] =
      entity.rFNotifications?.map((v) => v.toJson()).toList();
  ...
  data['login_page_info'] = entity.loginPageInfo?.toJson();
  return data;
}
...
extension IndexDataExtension on IndexData {
  IndexData copyWith({
    ...
    IndexDataLoginPageInfo? loginPageInfo,
  }) {
    return IndexData()
      ..aUser = aUser ?? this.aUser
      ..bProductsNewestUpdatedAt = bProductsNewestUpdatedAt ??
          this.bProductsNewestUpdatedAt
      ..bProducts = bProducts ?? this.bProducts
      ..bCProductFeaturesUpdatedAt = bCProductFeaturesUpdatedAt ??
          this.bCProductFeaturesUpdatedAt
      ..bCProductFeatures = bCProductFeatures ?? this.bCProductFeatures
      ..dBorrowsNewestUpdatedAt = dBorrowsNewestUpdatedAt ??
          this.dBorrowsNewestUpdatedAt
      ..dBorrows = dBorrows ?? this.dBorrows
      ..rFNotificationsNewestUpdatedAt = rFNotificationsNewestUpdatedAt ??
          this.rFNotificationsNewestUpdatedAt
      ..rFNotifications = rFNotifications ?? this.rFNotifications
      ..qDBannersNewestUpdatedAt = qDBannersNewestUpdatedAt ??
          this.qDBannersNewestUpdatedAt
      ...
      ..loginPageInfo = loginPageInfo ?? this.loginPageInfo;
  }
}

IndexDataAUser $IndexDataAUserFromJson(Map<dynamic, dynamic> json) {
  ...
  final String? eBankcardNo = jsonConvert.convert<String>(
      json['e_bankcard_no']);
  if (eBankcardNo != null) {
  ...
  final String? mChannelHide = jsonConvert.convert<String>(
      json['m_channel_hide']);
  ...
  final String? rCurrentBorrowId = jsonConvert.convert<String>(
      json['r_current_borrow_id']);
  if (rCurrentBorrowId != null) {
    indexDataAUser.rCurrentBorrowId = rCurrentBorrowId;
  }
  final int? sCurrentVerifyId = jsonConvert.convert<int>(
      json['s_current_verify_id']);
  if (sCurrentVerifyId != null) {
    indexDataAUser.sCurrentVerifyId = sCurrentVerifyId;
  }
  final String? tCurBorrowStatus = jsonConvert.convert<String>(
      json['t_cur_borrow_status']);
  if (tCurBorrowStatus != null) {
    indexDataAUser.tCurBorrowStatus = tCurBorrowStatus;
  }
  final String? uOnWayProductId = jsonConvert.convert<String>(
      json['u_on_way_product_id']);
  ...
  final String? wRegisterType = jsonConvert.convert<String>(
      json['w_register_type']);
  ...
  final String? ySuspectUnload = jsonConvert.convert<String>(
      json['y_suspect_unload']);
  ...
  final int? aAReviewAdminId = jsonConvert.convert<int>(
      json['a_a_review_admin_id']);
  if (aAReviewAdminId != null) {
    indexDataAUser.aAReviewAdminId = aAReviewAdminId;
  }
  final int? aBCollectionAdminId = jsonConvert.convert<int>(
      json['a_b_collection_admin_id']);
  ...
  final int? aHOverdueTimes = jsonConvert.convert<int>(
      json['a_h_overdue_times']);
  ...
  final int? aQSettledCount = jsonConvert.convert<int>(
      json['a_q_settled_count']);
...
extension IndexDataAUserExtension on IndexDataAUser {
  IndexDataAUser copyWith({
    ...
    return IndexDataAUser()
      ...
      ..aIRepayMaxOverdueDays = aIRepayMaxOverdueDays ??
          this.aIRepayMaxOverdueDays
...
IndexDataBProducts $IndexDataBProductsFromJson(Map<dynamic, dynamic> json) {
  ...
  final int? aProductSnapshotId = jsonConvert.convert<int>(
      json['a_product_snapshot_id']);
  ...
  final int? hServiceFeeRate = jsonConvert.convert<int>(
      json['h_service_fee_rate']);
  ...
  final int? qUnlockCreditFraction = jsonConvert.convert<int>(
      json['q_unlock_credit_fraction']);
  ...
  final int? sMaxOverdueDays = jsonConvert.convert<int>(
      json['s_max_overdue_days']);
  if (sMaxOverdueDays != null) {
    indexDataBProducts.sMaxOverdueDays = sMaxOverdueDays;
  }
  final int? tMaxOverdueTimes = jsonConvert.convert<int>(
      json['t_max_overdue_times']);
  ...
  final String? xIntroduction = jsonConvert.convert<String>(
      json['x_introduction']);
  ...
  final int? aBDayValidCount = jsonConvert.convert<int>(
      json['a_b_day_valid_count']);
  if (aBDayValidCount != null) {
    indexDataBProducts.aBDayValidCount = aBDayValidCount;
  }
  final int? aCSnapshotCount = jsonConvert.convert<int>(
      json['a_c_snapshot_count']);
...
extension IndexDataBProductsExtension on IndexDataBProducts {
  IndexDataBProducts copyWith({
    ...
    return IndexDataBProducts()
      ...
      ..pUrl = pUrl ?? this.pUrl
      ..qUnlockCreditFraction = qUnlockCreditFraction ??
          this.qUnlockCreditFraction
...
IndexDataBCProductFeatures $IndexDataBCProductFeaturesFromJson(
...
Map<String, dynamic> $IndexDataBCProductFeaturesToJson(
    IndexDataBCProductFeatures entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['id'] = entity.id;
...
IndexDataDBorrows $IndexDataDBorrowsFromJson(Map<dynamic, dynamic> json) {
  ...
  final String? aUStatusTime = jsonConvert.convert<String>(
      json['a_u_status_time']);
...
IndexDataRFNotifications $IndexDataRFNotificationsFromJson(
    Map<dynamic, dynamic> json) {
...
Map<String, dynamic> $IndexDataRFNotificationsToJson(
    IndexDataRFNotifications entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['id'] = entity.id;
...
IndexDataRemind $IndexDataRemindFromJson(Map<dynamic, dynamic> json) {
...
IndexDataLoginPageInfo $IndexDataLoginPageInfoFromJson(
    Map<String, dynamic> json) {
  final IndexDataLoginPageInfo indexDataLoginPageInfo = IndexDataLoginPageInfo();
  final String? appName = jsonConvert.convert<String>(json['app_name']);
  if (appName != null) {
    indexDataLoginPageInfo.appName = appName;
  }
  final String? firstTip = jsonConvert.convert<String>(json['first_tip']);
  if (firstTip != null) {
    indexDataLoginPageInfo.firstTip = firstTip;
  }
  final String? secondTip = jsonConvert.convert<String>(json['second_tip']);
  if (secondTip != null) {
    indexDataLoginPageInfo.secondTip = secondTip;
  }
  final bool? showContactPhone = jsonConvert.convert<bool>(
      json['show_contact_phone']);
  if (showContactPhone != null) {
    indexDataLoginPageInfo.showContactPhone = showContactPhone;
  }
  final String? contactPhone = jsonConvert.convert<String>(
      json['contact_phone']);
  if (contactPhone != null) {
    indexDataLoginPageInfo.contactPhone = contactPhone;
  }
  final bool? showContactWa = jsonConvert.convert<bool>(
      json['show_contact_wa']);
  if (showContactWa != null) {
    indexDataLoginPageInfo.showContactWa = showContactWa;
  }
  final String? contactWa = jsonConvert.convert<String>(json['contact_wa']);
  if (contactWa != null) {
    indexDataLoginPageInfo.contactWa = contactWa;
  }
  final int? captchaShowCount = jsonConvert.convert<int>(
      json['captcha_show_count']);
  if (captchaShowCount != null) {
    indexDataLoginPageInfo.captchaShowCount = captchaShowCount;
  }
  return indexDataLoginPageInfo;
}

Map<String, dynamic> $IndexDataLoginPageInfoToJson(
    IndexDataLoginPageInfo entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['app_name'] = entity.appName;
  data['first_tip'] = entity.firstTip;
  data['second_tip'] = entity.secondTip;
  data['show_contact_phone'] = entity.showContactPhone;
  data['contact_phone'] = entity.contactPhone;
  data['show_contact_wa'] = entity.showContactWa;
  data['contact_wa'] = entity.contactWa;
  data['captcha_show_count'] = entity.captchaShowCount;
  return data;
}

extension IndexDataLoginPageInfoExtension on IndexDataLoginPageInfo {
  IndexDataLoginPageInfo copyWith({
    String? appName,
    String? firstTip,
    String? secondTip,
    ...
    bool? showContactWa,
    String? contactWa,
    int? captchaShowCount,
  }) {
    return IndexDataLoginPageInfo()
      ..appName = appName ?? this.appName
      ..firstTip = firstTip ?? this.firstTip
      ..secondTip = secondTip ?? this.secondTip
      ..showContactPhone = showContactPhone ?? this.showContactPhone
      ..contactPhone = contactPhone ?? this.contactPhone
      ..showContactWa = showContactWa ?? this.showContactWa
      ..contactWa = contactWa ?? this.contactWa
      ..captchaShowCount = captchaShowCount ?? this.captchaShowCount;
  }
}